...
export async function dispatch(
  ...
  switch (method) {
    ...
    case 'hybridDisassemble':
      return _hybridDisassemble(args.bytes, args.baseAddress, args.is64, args.seeds, ctx(state), args.pdataRanges);
    ...
    case 'buildAllXrefs': {
      ...
      return _buildAllXrefs(args.bytes, args.baseAddress, args.is64, args.stringAddrs, args.iatAddrs, cs, args.funcEntries, args.dataSections);
    }
